...
public class FilePaths {
    ...
    public static final Path RESULTS_2014_EXPANDED_FILE = FilePaths.RESULTS_DIR.resolve("models")
                                                                               .resolve("results-2014-BM25_Lucene-expanded.txt");
    public static final Path RESULTS_2015_EXPANDED_FILE = FilePaths.RESULTS_DIR.resolve("models")
                                                                               .resolve("results-2015-BM25_Lucene-expanded.txt");
