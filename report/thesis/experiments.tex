...
\centerline{
  ...
  \caption{P@10 improvements using SVM with Precision@K loss function.}
\end{figure}
...
\centerline{
  ...
  \caption{P@10 improvements using SVM with Recall@K loss function.}
\end{figure}
...
\centerline{
  ...
  \caption{P@10 improvements per query using SVM with Recall@K loss function.}
\end{figure}
